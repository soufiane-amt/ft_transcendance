  ...
  return (
    ...
    >
      ...
      <div className="bg-[#E4E7FF] rounded shadow-lg w-[95vw] h-[90vh] flex flex-col   p-[20px] box-border overflow-auto items-center z-[51] scrolling">
        ...
        <div className="w-full md:max-w-[800px] h-[97%] flex flex-col items-center">
          <div className="m-auto">
            <div className="m-[8px] mb-[20px] ">
              ...
              <p className={`${mono.className} text-sm`}>
                ...
                account, we require you to set up Two-Factor Authentication
                (2FA).
              </p>
              <p className={`${mono.className} text-sm`}>
                2FA adds an extra layer of protection to your account by
                requiring you to enter a unique verification code, in addition
                to your password, each time you sign in.
              </p>
              <p className={`${mono.className} text-sm`}>
                To get started, you will need to install the Google
                Authenticator app on your mobile device. Google Authenticator
                generates the verification codes for your account.
              </p>
              <h2 className={`${mono.className} text-sm`}>
