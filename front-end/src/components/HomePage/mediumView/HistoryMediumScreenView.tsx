  ...
  return (
    <div className="md:max-2xl:flex hidden items-center justify-between flex-col h-full p-[5%] overflow-auto">
      <div className="flex items-center justify-evenly gap-x-14 mt-[15%]">
        <div className="flex justify-normal items-start flex-col gap-y-16 w-[40%]">
          <h2 className={`text-[50px] text-[#343CFF] ${pixelfont.className}`}>
            History
          </h2>
          <div className="flex justify-normal items-start flex-col gap-y-8">
      ...
      <h6 className={`${mono.className} text-[#0D0149] text-center text-[13px] mt-[15px]`}>© 2023 retro ping pong. All rights reserved.</h6>
    </div>
  );
}
