...
export default function MobileView() {
  ...
  return (
    <div className="bg-[#0D0149]">
      <section
        id="home"
        className="bg-[#0D0149] flex flex-col items-center justify-around min-h-[100vh] p-[5%] pt-[90px] overflow-hidden"
      >
...
>>>>>>> origin/handleRank_branch
      ...
      >
        <h2 className={`text-[30px] text-[#0D0149] ${pixelfont.className}`}>
          History
        </h2>
        <motion.img
          initial={{
        ...
        />
        <div className="flex gap-8 flex-col max-w-[450px]">
          <p
      ...
      >
        <motion.h2
          ...
          className={`text-[30px] ${pixelfont.className}`}
        >
          About
        </motion.h2>
        <p
          className={`${mono.className} text-center text-[16px]  max-w-[450px]`}
        >
