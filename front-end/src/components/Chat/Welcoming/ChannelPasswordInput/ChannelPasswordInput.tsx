...
export function ChannelPasswordInput({
  handleVisibility,
  channelData,
}: ChannelPasswordInputProps) {
    ...
    <div className={style.dark_background}>
      <div data-inside-modal ref={ref} className={style.channel_password_input}>
        <div className={style.channel_password_input__channel}>
          <img
            className={style.channel_password_input__avatar}
            src={channelData.image}
            alt="avatar"
          />
          <span className={style.channel_password_input__name}>
            {channelData.name}
          </span>
        </div>
        <div className={style.channel_password__input_field}>
          ...
          {displayJoinFailure && (
            <span className={style.channel_password_input__join_failure}>
              Denied permission
            </span>
          )}
        </div>
