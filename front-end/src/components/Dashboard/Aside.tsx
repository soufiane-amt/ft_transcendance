        ...
        <div className="elementscontainer">
          <div className="myaside">
            ...
            <div className="myaside2">
              <img src="../new-moon.png" alt="Photo" width={10} height={10} />
              <p>
                <span>{totalonlineUsers}</span>Players online
              </p>
            </div>
          </div>
          <hr id="aside-line"></hr>
          <div className="myaside">
            ...
            {isactivedashboard && (
              <>
                ...
                <div
                  className="homepage"
                  onClick={() => onSelectSection("statistic")}
                >
                  <img
                    src="../bar-chart.png"
                    alt="Photo"
          ...
          <div className="myaside">
            <div className="myaside1 aside">
              ...
              <img
                ...
                width={20}
                height={20}
                onClick={handleuparrowadduser}
              />
            </div>
            {isactiveadduser && (
              <div
                className="homepage"
                onClick={() => onSelectSection("add-user")}
              >
                <img
                  src="../add-user (3).png"
                  alt="Photo"
