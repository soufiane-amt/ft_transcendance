...
export class DashboardController {
    constructor(private readonly user : UserCrudService, private readonly resultgame : GameCrudService, private readonly websocketDashboard: WebSocketGatewayClass) {}
    @Get('Dashboard')
  display()
  {
      const user1 = {
