...
-- CreateEnum
CREATE TYPE "RelationStatus" AS ENUM ('FRIENDS', 'BLOCK');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ACCEPTED_INVITATION', 'FRIENDSHIP_REQUEST');
...
CREATE TABLE "Friendships" (
    ...
    "relationStatus" "RelationStatus" NOT NULL DEFAULT 'FRIENDS',
