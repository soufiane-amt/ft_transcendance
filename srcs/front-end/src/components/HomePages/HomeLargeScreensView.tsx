...
export default function HomeLargeScreensView() {
    return (
    <div className="sm:md:lg:flex hidden  items-center w-full h-full justify-between m-[30px]">
        <div className="w-[50%] h-[100%] relative ml-[20px]">
        ...
        <div className="w-[40%] h-[100%] flex items-center justify-around flex-col">
            <h1 className={`font-extrabold text-white`}>Retro Ping Pong</h1>
