...
export default function HistorySmallScreenView() {
  return (
    <div
      className={`sm:md:hidden flex flex-col items-center justify-between h-full overflow-auto p-[5%]`}
    >
      <h2
        className={`text-[30px] text-[#343CFF] ${pixelfont.className} mt-[30px]`}
      >
        History
      </h2>
      <Image
      ...
      <div className="flex gap-8 flex-col">
        ...
        >
          ...
          industry. The original Pong consisted of two paddles that players used
          to volley a small ball back and forth across a screen.
        </p>
        <p
          className={`${mono.className} text-[#0D0149] text-center text-[16px]`}
        >
          ...
          and decided to manufacture the game. The concept of the game was based
          on an electronic ping-pong game included in the Magnavox Odyssey,
          which was the first home video game console.
        </p>
        <p
          className={`${mono.className} text-[#0D0149] text-center text-[16px]`}
        >
          In response to Pong’s success, Magnavox later sued Atari for patent
          infringement. Despite this, Pong was the first commercially successful
          video game, and it helped establish the video game industry along with
          the Magnavox Odyssey. After its release, several companies began
          producing games that closely mimicked its gameplay.
        </p>
        <p
          className={`${mono.className} text-[#0D0149] text-center text-[16px]`}
        >
      ...
      <h6 className={`${mono.className} text-[#0D0149] text-center text-[13px] my-[30px]`}>© 2023 retro ping pong. All rights reserved.</h6>
    </div>
  );
}
